...
import { ErrorMessage } from "../../../common/Error/ErrorMessage/ErrorMessage";
  ...
  return (
    <div className={s.profileData}>
      <div className={s.profileDataInfo}>
        <ErrorMessage error={props.error} closeErrorApp={props.closeErrorApp} />
        ...
        <div className={`${s.lookingJob} ${s.itemProfileData}`}>
          ...
          <span className={s.valueProfileData}>
        ...
        {props?.profile?.contacts
          ? Object.keys(props.profile.contacts).map((key) => (
              <Contacts
                ...
                contactTitle={key}
                contactValue={
                  props.profile!.contacts![key as keyof ContactsProfileType]
                }
              />
            ))
          : null}
      ...
      {props.isOwner && (
        <button className={s.button} onClick={props.editMode}>
          edit
        </button>
      )}
    </div>
