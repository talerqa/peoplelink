      ...
      <form action="" onSubmit={formik.handleSubmit}>
        <div className={s.profileDataFormBlock}>
          ...
          <div className={s.profileDataFormItem}>
            ...
            <input
              className={
                formik.touched?.contacts?.website &&
          ...
          <div className={s.profileDataFormItem}>
            ...
            <input
              className={
                formik.touched?.contacts?.twitter &&
          ...
          <div className={s.profileDataFormItem}>
            ...
            <input
              className={
                formik.touched?.contacts?.instagram &&
          ...
          <div className={s.profileDataFormItem}>
            ...
            <input
              className={
                formik.touched?.contacts?.youtube &&
          ...
          <div className={s.profileDataFormItem}>
            ...
            <input
              className={
                formik.touched?.contacts?.github &&
          ...
          <div className={s.profileDataFormItem}>
            ...
            <input
              className={
                formik.touched?.contacts?.mainLink &&
        ...
        <button type={"submit"} className={s.saveProfileDataBtn}>
          Save
        </button>
      </form>
    </div>
